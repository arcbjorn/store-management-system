...
func startTestLaptopServer(t *testing.T, laptopStore services.LaptopStore, imageStore services.ImageStore) string {
	laptopServer := services.NewLaptopServer(laptopStore, imageStore)
